...
source("R/01_download_data/get_deprivation_data.R")
...
source("R/01_download_data/get_poverty_data.R")
source("R/01_download_data/get_socialsecurity_data.R")

# 02 prep data -----------------------------------------------------------------

source("R/02_prep_data/prep_ASHE_data.R")
source("R/02_prep_data/prep_deprivation_data.R")
...
source("R/02_prep_data/prep_poverty_data.R")
