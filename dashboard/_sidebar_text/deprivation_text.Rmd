...
SIMD is based on a range of indicators in seven domains: Income, Employment, Health, Education, Housing, Crime, and Access to Services (= rurality). Indicator definitions can be found in the [SIMD 2020 technical notes](https://www.gov.scot/publications/simd-2020-technical-notes/).
